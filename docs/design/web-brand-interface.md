...
| 원시 팔레트 | 출처 | 서비스 역할 |
| --- | --- | --- |
| #000000 | 사용자 브랜드 기준, 공개 이미지에도 확인된 값 | 본문·제목·주요 행동 |
| #FF9398 | 사용자 브랜드 기준 | 홈·소개 색면, 선택 강조 |
| #D14836 | 사용자 브랜드 기준 | 유기적 장식·브랜드 포인트 |
| #FFFFFF | 사용자가 제공한 공개 이미지 추출값 | 페이지·카드·입력·다이얼로그·시트, 역상 글자 |
| #1D1841 | 사용자가 제공한 공개 이미지 추출값 | DEMO 안내 등 어두운 보조 패널 |
