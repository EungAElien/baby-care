        ...
        <form onSubmit={submit} className="flex flex-col gap-4" noValidate>
          ...
          {type === "SLEEP" && (
            <label className="flex flex-col gap-1 text-sm text-foreground">
              ...
              <input type="datetime-local" {...register("endedAt")} aria-invalid={Boolean(formState.errors.endedAt)} className="min-h-11 rounded-md border border-border bg-background px-3" />
