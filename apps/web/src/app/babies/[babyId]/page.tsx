...
export default async function BabyHomePage({
  params,
    ...
    <div className="home-grid">
      ...
      <section className="brand-hero" aria-labelledby="home-title">
        ...
        <div className="hero-footer">
          ...
          <p className="text-sm">
            감지 지원 여부를 확인한 뒤 시작해요.
            <br />
            직접 녹음과 파일 입력도 여기에서 할 수 있어요.
          </p>
        </div>
      </section>
      <div className="home-aside">
        ...
        <section className="screen-section">
          <div>
            <p className="section-eyebrow">보호자가 직접 남기는 기록</p>
            <h2 className="mt-1 text-lg font-bold">방금 한 돌봄, 잊기 전에</h2>
          </div>
        ...
        <ActionButton variant="ghost" size="medium" asChild>
          <Link href={`/babies/${babyId}/care-team`}>
