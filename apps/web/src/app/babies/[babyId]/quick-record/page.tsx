...
import { TextField, TextFieldTextarea } from "@/components/seed-design/ui/text-field";
...
export default function QuickRecordPage() {
  ...
  return <div className="flex flex-col gap-6">
    <PageHeading title="돌봄을 남겨요" description="실제로 한 일과 직접 관찰한 모습을 구분해 기록해요." />
    <div className="record-methods" role="group" aria-label="기록 입력 방식">
      <button type="button" aria-pressed={mode === "structured"} onClick={() => setMode("structured")}><NotebookPen aria-hidden="true" size={22} /><span>선택해서 기록<small>수유 · 수면 · 기저귀 · 달래기</small></span></button>
