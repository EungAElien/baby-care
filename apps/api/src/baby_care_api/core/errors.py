...
ERROR_STATUS: Final[Mapping[ErrorCode, int]] = {
    ...
    ErrorCode.REAUTH_PROOF_INVALID: HTTPStatus.UNAUTHORIZED,
    ...
    ErrorCode.CHILD_DATA_VERIFICATION_REQUIRED: HTTPStatus.FORBIDDEN,
    ...
    ErrorCode.AUTH_PROVIDER_REVOCATION_FAILED: HTTPStatus.SERVICE_UNAVAILABLE,
}
